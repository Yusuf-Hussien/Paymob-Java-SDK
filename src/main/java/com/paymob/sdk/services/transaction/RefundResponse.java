...
public class RefundResponse {
    ...
    @JsonProperty("is_refunded")
    private Boolean isRefundedFlag;
    ...
    public Boolean getIsCaptureFlag() {
        return isCaptureFlag;
    }

    public void setIsCaptureFlag(Boolean isCaptureFlag) {
        this.isCaptureFlag = isCaptureFlag;
    }

    public Boolean getIsRefundedFlag() {
        return isRefundedFlag;
    }

    public void setIsRefundedFlag(Boolean isRefundedFlag) {
        this.isRefundedFlag = isRefundedFlag;
    }
