...
/**
 * Utility class for test data and configurations.
 */
public class TestUtils {
    ...
    public static BillingData createTestBillingData(String firstName, String lastName, String email, String phone) {
    ...
    /**
     * Creates a valid intention request for testing.
     */
    public static com.paymob.sdk.services.intention.IntentionRequest createTestIntentionRequest() {
        ...
        com.paymob.sdk.services.intention.IntentionRequest request = 
            new com.paymob.sdk.services.intention.IntentionRequest(
    ...
    /**
     * Creates an invalid intention request for testing validation.
     */
    public static com.paymob.sdk.services.intention.IntentionRequest createInvalidIntentionRequest() {
        BillingData billingData = createTestBillingData();
        Item item = createTestItem();
        
        // Create request with mismatched amount (should be 10000 but we'll use 5000)
        com.paymob.sdk.services.intention.IntentionRequest request = 
            new com.paymob.sdk.services.intention.IntentionRequest(
    ...
    /**
     * Sleep for a specified duration without throwing InterruptedException.
     */
     ...
     */
    public static boolean waitForCondition(java.util.function.BooleanSupplier condition, long timeoutMillis) {
